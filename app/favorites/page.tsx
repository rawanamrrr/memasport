        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-light tracking-wider mb-2 text-white">My Favorites</h1>
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: "100px" }}
            ...
            >
              ...
              >
                <div className="relative mx-auto mb-6 flex justify-center">
                  <div className="w-28 h-28 bg-gradient-to-r from-orange-500/10 to-orange-600/10 rounded-full flex items-center justify-center">
                    <Heart className="h-14 w-14 text-orange-400" />
                  </div>
                </div>
                <h2 className="text-2xl font-light tracking-wider mb-4 text-orange-500">No Favorites Yet</h2>
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: "100px" }}
                ...
                >
                  <div className="group relative h-full">
                    ...
                    <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 h-full relative overflow-hidden">
                      {/* Purple transparent rectangles */}
                      <motion.div 
                        className="absolute -inset-4 bg-gradient-to-r from-orange-400/10 to-orange-600/10 rounded-lg -z-10"
                        animate={{
                      ...
                      />
                      <motion.div 
                        className="absolute -inset-2 bg-gradient-to-r from-orange-300/15 to-orange-600/15 rounded-lg -z-10"
                        animate={{

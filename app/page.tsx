...
import { ArrowRight, Star, ShoppingCart, Heart, X, Instagram, Facebook, Package, ChevronLeft, ChevronRight, Zap, Target, Award, Users, TrendingUp, Shield, Clock } from "lucide-react"
  ...
  const products = [
    {
      ...
      description: "Professional-grade equipment for every sport and fitness level",
      image: "/placeholder-sports-equipment.jpg?height=400&width=300",
      category: "equipment",
    },
    {
      id: "apparel",
      title: "Athletic Apparel",
      description: "High-performance sportswear designed for champions",
      image: "/placeholder-sports-apparel.jpg?height=400&width=300",
      category: "apparel",
    },
    {
      id: "accessories",
      title: "Accessories",
      description: "Essential accessories to complete your athletic journey",
      image: "/placeholder-sports-accessories.jpg?height=400&width=300",
      category: "accessories",
    },
    {
      id: "outlet",
      title: "Outlet",
      description: "Limited-time offers and exclusive deals on premium gear",
      image: "/placeholder-sports-outlet.jpg",
      category: "outlet",
    },
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center px-4 py-2 bg-orange-500/10 border border-orange-500/30 rounded-full mb-8">
              <Zap className="w-4 h-4 text-orange-500 mr-2" />
              <span className="text-orange-400 text-sm font-medium">PREMIUM ATHLETIC GEAR</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Discover the ultimate collection of professional sports equipment and athletic wear designed for champions who demand excellence.
            </p>
          </motion.div>
          ...
          >
            <Button
              size="lg"
              className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-2xl hover:shadow-orange-500/25 transition-all duration-300"
            >
              Shop Now
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {selectedProduct.sizes.map((size) => (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          className={`border-2 rounded-xl p-3 text-center transition-all ${selectedSize?.size === size.size
      ...
      <section className="py-20 bg-black/50 backdrop-blur-sm">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { number: "50K+", label: "Athletes Served", icon: Users },
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 bg-orange-500/10 border border-orange-500/30 rounded-full mb-8">
              ...
              <span className="text-orange-400 text-sm font-medium">CATEGORIES</span>
            </div>
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Discover our carefully curated collections designed for every athlete and sport
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {products.map((product, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 group-hover:border-orange-500/50 transition-all duration-500">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 bg-orange-500/10 border border-orange-500/30 rounded-full mb-8">
              ...
              <span className="text-orange-400 text-sm font-medium">BESTSELLERS</span>
            </div>
            <h2 className="text-5xl md:text-7xl font-black text-white mb-6">
              TOP
              <span className="block bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Discover the sports equipment our athletes trust the most for peak performance
            </p>
          </motion.div>
                      ...
                      return (
                        ...
                        >
                          <div className="group relative h-full">
                            ...
                            {/* Modern Product Card */}
                            <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl overflow-hidden border border-gray-700 hover:border-orange-500/50 transition-all duration-500 h-full mr-4 hover:shadow-2xl hover:shadow-orange-500/10">
                              <Link href={`/products/${product.category}/${product.id}`} className="block relative aspect-square">
                                ...
                                <motion.button
                                  ...
                                  whileTap={{ scale: 0.9 }}
                                  onClick={(e) => handleFavoriteClick(e, product)}
                                  className="absolute top-4 right-4 p-3 bg-black/50 backdrop-blur-sm rounded-full hover:bg-orange-500 transition-colors"
                                >
                                  <Heart
                                    className={`h-5 w-5 ${isFavorite(product.id)
                                      ...
                                      {(() => {
                                        if (product.isGiftPackage) {
                                          ...
                                          if (packageOriginalPrice > 0 && packagePrice < packageOriginalPrice) {
                                            return (
                                              <>
                                                <span className="line-through text-gray-400 text-lg mr-2">EGP{packageOriginalPrice}</span>
                                                <span className="text-orange-400">EGP{packagePrice}</span>
                                              </>
                                            );
                                          } else {
                                            return <span className="text-white">EGP{packagePrice}</span>;
                                          }
                                        }
                                        ...
                                        if (smallestOriginalPrice > 0 && smallestPrice < smallestOriginalPrice) {
                                          return (
                                            <>
                                              <span className="line-through text-gray-400 text-lg mr-2">EGP{smallestOriginalPrice}</span>
                                              <span className="text-orange-400">EGP{smallestPrice}</span>
                                            </>
                                          );
                                        } else {
                                          return <span className="text-white">EGP{smallestPrice}</span>;
                                        }
                                      })()}
                                    </div>
                ...
                <div className="flex justify-center mt-4 md:hidden">
                  {bestSellers.map((_, index) => (
                    <button
                      ...
                      className={`w-2 h-2 mx-1 rounded-full transition-colors ${index === selectedIndex ? 'bg-black' : 'bg-gray-300'
                        }`}
                        ...
                        return (
                          ...
                          >
                            <div className="group relative h-full">
                              ...
                              {/* Product Card */}
                              <Card className="luxury-card equipment-card border-0 shadow-lg hover:shadow-xl transition-all duration-300 h-full mr-4 hover-lift">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover our four distinctive sports collections, each crafted to enhance your performance and
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {products.map((product, index) => (
              ...
              >
                <Card
                  className="group cursor-pointer luxury-card equipment-card border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden hover-lift performance-indicator"
                  onClick={() => handleCollectionClick(product.id, product.category)}
                >
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-light tracking-wider mb-6">The Science of Performance</h2>
              <motion.p
                ...
                viewport={{ once: true }}
              >
                At Mema Sports, we believe that every athlete deserves the best. Our engineers and designers craft each
                piece of equipment with precision and passion, using only the finest materials and cutting-edge technology.
              </motion.p>
              <motion.p
                ...
                viewport={{ once: true }}
              >
                From training to competition, our gear is designed to enhance your performance, boost your confidence,
                and help you achieve your athletic goals.
              </motion.p>
              <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
            ...
            >
              <Image
                src="/placeholder-sports-equipment.jpg?height=500&width=400"
